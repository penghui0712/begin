    ...
    $(".sm_detail_v").addClass(cn);
      ...
      var searchSuccess = function(datas){
	    ...
	    if(status==100){
		 ...
		 if(productPropertys==null || productPropertys==""){
			 $(".service_info_item").remove();
		 }else{
			 var product = productPropertys.split(";");
		 }
		 for(var i=0;i<product.length;i++){
			 var five = '<div class="service_info_item" style="min-height:260px;"><table class="stable" name="table'+i+'" style="height:180px;"></table>'+
